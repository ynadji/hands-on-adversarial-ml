...
def maybe_download_file(url, datadir='/home/jovyan/data/mnist', force=False):
  try:
...
def download_and_parse_mnist_file(file_name, datadir='/home/jovyan/data/mnist', force=False):
...
def data_mnist(datadir='/home/jovyan/data/mnist', train_start=0,
